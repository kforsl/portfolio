...
function Navigation({ executeScroll }) {
  return (
    <>
      <nav className="fixed -left-20 top-2/4 z-10 w-fit -translate-y-2/4 rounded-r-lg bg-grayish/50 shadow-social backdrop-blur-sm transition-all duration-300 hover:left-0">
